<template>
  <div>
    ...
    <el-dialog title="发表评论" :visible.sync="dialogFormVisible" append-to-body>
      <el-form :model="comment" :rules="rules" ref="comment" :label-width="formLabelWidth">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="commentHandler('comment')">确 定</el-button>
      </div>
    </el-dialog>
    ...
    commentHandler(formName){
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$message.warning("请检查所填写的评论信息！")
          return false;
        }
      });
